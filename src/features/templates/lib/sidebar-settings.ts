...
export const templatesSidebarSections: SettingSection[] = [
  ...
  },
  {
    ...
    settings: [
      { label: "Trending slots", description: "How many top templates are treated as currently trending. Higher value: more templates receive the Trending tag and participate in rotation.", kind: "stepper", initialValue: 21, min: 1, max: 100, step: 1, mode: "integer" },
      { label: "Feature count threshold", description: "How many times a template can be featured in Trending before repeat penalties begin. Higher value: templates get more free repeat appearances before decay starts.", kind: "stepper", initialValue: 3, min: 0, max: 20, step: 1, mode: "integer" },
      {
        label: "Feature count window",
        description: "How far back the system looks when counting past Trending appearances. Higher value: repeat penalties consider a longer history.",
        kind: "dropdown",
        initialValue: "90d",
